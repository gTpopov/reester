     ...
     */
     function redirect() {
         ...
         if(param=='1.7.4' || param=='1.7.3') {
             window.location.replace('/addObject/index?act=1');
         }
         else if(param=='1.6.5') {
             window.location.replace('/addObject/index?act=2');
         }
         else if(param=='1.6.4' || param=='1.6.3') {
             window.location.replace('/addObject/index?act=3');
         }
         else if(param=='2.6.4' || param=='2.6.3') {
             window.location.replace('/addObject/index?act=4');
         }
         else {
             window.location.replace('/addObject/index?act=1');
         }
